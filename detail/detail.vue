	...
	<view class="container">
		...
		<tui-bottom-popup :show="popupShow" @close="hidePopup">
			<view class="tui-popup-box">
				...
				<tui-specification v-model="ddd" :simulated="simulatedDATA"></tui-specification>
				<view class="tui-number-box tui-bold tui-attr-title">
					<view class="tui-attr-title">购买数量</view>
...
<script>
	...
	import tuiSpecification from "@/components/specification/specification"
	export default {
		components: {
			tuiIcon,
			tuiTag,
